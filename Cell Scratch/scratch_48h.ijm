...
xMin = 1000;           // Left black brush boundary: everything to the left is painted black (exclude edge interference)
xMax = 4400;           // Right black brush boundary: everything to the right is painted black (exclude edge interference)
//centerStart = 1800;    // Center white brush start: forced white to eliminate physical scratch interference
//centerEnd = 3600;      // Center white brush end: forced white to eliminate physical scratch interference

// 2. Core Algorithm Parameters
MINIMAL_SIZE = 10000; // Minimum area threshold
VARIANCE_FILTER_RADIUS = 5;
THRESHOLD = 25;
RADIUS_CLOSE = 6;
// =====================
